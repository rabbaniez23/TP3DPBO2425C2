...
public class Habitat {
    ...
    public String getTipeIklim() { return tipeIklim; }
    public int getLuasArea() { return luasArea; }

    public void setNamaHabitat(String namaHabitat) { this.namaHabitat = namaHabitat; }
    public void setTipeIklim(String tipeIklim) { this.tipeIklim = tipeIklim; }
    public void setLuasArea(int luasArea) { this.luasArea = luasArea; }
